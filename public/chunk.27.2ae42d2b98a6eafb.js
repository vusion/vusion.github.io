...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_script_index_0_Vusion_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_README_md__ = __webpack_require__(483);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_c11e59f0_hasScoped_false_preserveWhitespace_false_buble_transforms_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_Vusion_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_README_md__ = __webpack_require__(484);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_c11e59f0_hasScoped_false_preserveWhitespace_false_buble_transforms_Vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_Vusion_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_README_md__["a" /* default */],
...
/* harmony default export */ __webpack_exports__["a"] = ({ components: { 'anonymous-7b22ce56': { "template": "<div class=\"u-example\"><u-checkbox>多选框</u-checkbox></div>" }, 'anonymous-4705494d': { "template": "<div class=\"u-example\"><u-checkbox v-model=\"value\">{{ value }}</u-checkbox></div>",
            data() {
                return {
                    value: true
                };
            }
        }, 'anonymous-24caeaf3': { "template": "<div class=\"u-example\"><u-linear-layout><u-checkbox :value=\"true\" readonly>只读</u-checkbox><u-checkbox :value=\"true\" disabled>禁用</u-checkbox></u-linear-layout></div>" }, 'anonymous-00668bd5': { "template": "<div class=\"u-example\"><u-checkbox :value=\"null\">不确定</u-checkbox></div>" }, 'anonymous-685c1ddc': { "template": "<div class=\"u-example\"><u-checkboxes v-model=\"checkedList\"><u-checkbox label=\"水杯\">水杯</u-checkbox><u-checkbox label=\"坚果\">坚果</u-checkbox><u-checkbox label=\"毛巾\">毛巾</u-checkbox><u-checkbox label=\"沙发\">沙发</u-checkbox></u-checkboxes>\n    {{ checkedList }}</div>",
            data() {
                return {
                    checkedList: ['毛巾', '沙发']
                };
            }
        }, 'anonymous-65174510': { "template": "<div class=\"u-example\"><u-checkboxes :min=\"1\" :max=\"2\" v-model=\"checkedList\"><u-checkbox label=\"水杯\">水杯</u-checkbox><u-checkbox label=\"坚果\">坚果</u-checkbox><u-checkbox label=\"毛巾\">毛巾</u-checkbox><u-checkbox label=\"沙发\">沙发</u-checkbox></u-checkboxes>\n    {{ checkedList }}</div>",
            data() {
                return {
                    checkedList: ['毛巾', '沙发']
                };
        ...
        }, 'anonymous-0fa749a4': { "template": "<div class=\"u-example\"><u-checkbox v-model=\"allChecked\" @check=\"checkAll($event.value)\">全选</u-checkbox><u-checkboxes v-model=\"checkedList\" @check=\"onCheck($event.value)\"><u-checkbox label=\"水杯\">水杯</u-checkbox><u-checkbox label=\"坚果\">坚果</u-checkbox><u-checkbox label=\"毛巾\">毛巾</u-checkbox><u-checkbox label=\"沙发\">沙发</u-checkbox></u-checkboxes>\n    {{ checkedList }}</div>",
            data() {
                return {
                    allChecked: false,
                    checkedList: []
