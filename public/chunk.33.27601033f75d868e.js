...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_script_index_0_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_modularity_md__ = __webpack_require__(441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_d2d81634_hasScoped_false_preserveWhitespace_false_buble_transforms_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_modularity_md__ = __webpack_require__(442);
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_script_index_0_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_modularity_md__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_d2d81634_hasScoped_false_preserveWhitespace_false_buble_transforms_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_vusion_cli_node_modules_vue_md_loader_index_js_ref_5_1_modularity_md__["a" /* default */],
...
//
//
/* harmony default export */ __webpack_exports__["a"] = ({ components: { 'anonymous-1fdacbad': { "template": "<div class=\"u-example\">npm install --save-dev babel-preset-env</div>" }, 'anonymous-19dd34fa': { "template": "<div class=\"u-example\">{\n    \"presets\": [\"env\"]\n}</div>" }, 'anonymous-74df997e': { "template": "<div class=\"u-example\">{\n    \"uglifyJS\": true\n}</div>" }, 'anonymous-2d191e68': { "template": "<div class=\"u-example\">vusion build --uglify-js</div>" }, 'anonymous-2c47c9de': { "template": "<div class=\"u-example\"><p :class=\"$style.red\">\n    This should be red.\n</p></div>" }, 'anonymous-2b406046': { "template": "<div class=\"u-example\">._21t-NHydruDPXRXUWJnMmm {\n    color: red;\n}\n\n._2VTt8mZxuYxYIcjuT-eGzP {\n    font-weight: bold;\n}</div>" }, 'anonymous-66fe528e': { "template": "<div class=\"u-example\">u-sample.vue/\n    index.html\n    index.js\n    module.css</div>" }, 'anonymous-4107a9da': { "template": "<div class=\"u-example\"><div :class=\"$style.root\"><div :class=\"$style.track\"><div :class=\"$style.trail\"></div></div></div></div>" }, 'anonymous-303c9530': { "template": "<div class=\"u-example\"><u-button :class=\"$style.button\">Button</u-button></div>" }, 'anonymous-667dffec': { "template": "<div class=\"u-example\">{\n    \"extractCSS\": true\n}</div>" }, 'anonymous-63c0a72f': { "template": "<div class=\"u-example\">vusion build --extract-css</div>" }, 'anonymous-0dece8b3': { "template": "<div class=\"u-example\">.select:after {\n    icon-font: url('./icons/arrow-down.svg');\n    color: #666;\n}</div>" }, 'anonymous-ad5a1d88': { "template": "<div class=\"u-example\">.select:after {\n    font-family: 'vusion-icon-font';\n    font-style: normal;\n    font-weight: 400;\n    font-variant: normal;\n    text-decoration: inherit;\n    text-rendering: optimizeLegibility;\n    text-transform: none;\n    -moz-osx-font-smoothing: grayscale;\n    -webkit-font-smoothing: antialiased;\n    font-smoothing: antialiased;\n    content: '\\f106';\n    color: #666;\n}</div>" }, 'anonymous-2900c1b6': { "template": "<div class=\"u-example\"><div class=\"require('./inner.svg)\"></div>" }, 'anonymous-284f84e8': { "template": "<div class=\"u-example\">.root {\n    svg-sprite: url('./icons/refresh.svg');\n    width: 200px;\n    height: 120px;\n}</div>" }, 'anonymous-498e4bb8': { "template": "<div class=\"u-example\">.root {\n    background: url('/public/sprite.1c9f4bcca4a42798.svg#refresh');\n    width: 200px;\n    height: 120px;\n}</div>" } } });
