...
cssModules['$style'] = __webpack_require__(632);  this['$style'] = cssModules['$style']
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("vusion build --uglify-js\n")])]), _vm._v(" "), _c('h3', [_vm._v("CSS的模块化")]), _vm._v(" "), _c('p', [_vm._v("虽然SASS、LESS、Stylus等预处理器实现了CSS的文件拆分，但没有解决CSS模块化的痛点：选择器的局域化问题（全局污染问题）。")]), _vm._v(" "), _c('p', [_vm._v("按道理，一个模块化的文件应该要隐藏内部作用域，只暴露少量接口给使用者。而按照目前预处理器的方式，引入一个CSS模块后，已存在的样式仍有被覆盖的风险。")]), _vm._v(" "), _c('p', [_vm._v("为了避免全局选择器的冲突，也为了避免复杂、繁琐、弱约束的命名规范，我们采用"), _c('u-link', {
    attrs: {
      "href": "https://github.com/css-modules/css-modules"
    }
  }, [_vm._v("CSS Modules")]), _vm._v("来解决这个问题。")], 1), _vm._v(" "), _c('h4', [_vm._v("CSS Modules")]), _vm._v(" "), _c('p', [_vm._v("在单文件Vue中，在"), _c('code', {
    pre: true
  ...
  }, [_vm._v("style")]), _vm._v(">")]), _vm._v("\n")])]), _vm._v(" "), _c('p', [_vm._v("这些样式会转为")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-css"
    }
  ...
  }, [_vm._v("._21t-NHydruDPXRXUWJnMmm")]), _vm._v(" {\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  }, [_vm._v("color")]), _vm._v(": red;\n}\n\n"), _c('span', {
  ...
  }, [_vm._v("._2VTt8mZxuYxYIcjuT-eGzP")]), _vm._v(" {\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  ...
  }, [_vm._v("u-sample.vue/\n    index.html\n    index.js\n    module.css\n")])]), _vm._v(" "), _c('h4', [_vm._v("REA风格")]), _vm._v(" "), _c('p', [_vm._v("在CSS Modules的基础上，我们引入了"), _c('u-link', {
    attrs: {
      "href": "https://github.com/postcss/postcss"
    }
  }, [_vm._v("PostCSS")]), _vm._v("和它的一些plugins"), _c('u-link', {
    attrs: {
      "href": "https://github.com/vusion/vusion-cli/blob/master/webpack/base.js#L13"
    }
  }, [_vm._v("<code>")]), _vm._v("，用于简化样式的书写，最终形成一套特有的CSS书写风格——REA风格。")], 1), _vm._v(" "), _c('p', [_vm._v("REA表示Root、Element、Attribute，其中借鉴了BEM（Block、Element、Modifier）的一些思想，但它不需要那些繁琐的构词形式。")]), _vm._v(" "), _c('p', [_vm._v("它有以下一些规则：")]), _vm._v(" "), _c('ul', [_c('li', [_vm._v("class仅用于表示元素的在组件中的角色\n"), _c('ul', [_c('li', [_vm._v("根节点总是用"), _c('code', {
    pre: true
  }, [_vm._v(".root")])]), _vm._v(" "), _c('li', [_vm._v("子节点用一个简单的单词来表示，如"), _c('code', {
    pre: true
  }, [_vm._v("head")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("item")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("side")]), _vm._v("等")])])]), _vm._v(" "), _c('li', [_vm._v("attribute用于样式扩展，命名方式与常用的props保持一致\n"), _c('ul', [_c('li', [_vm._v("Boolean类型，如"), _c('code', {
    pre: true
  }, [_vm._v("selected")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("disabled")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("active")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("checked")]), _vm._v("等")]), _vm._v(" "), _c('li', [_vm._v("颜色，如"), _c('code', {
    pre: true
  }, [_vm._v("color=\"primary\"")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("color=\"success\"")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("color=\"error\"")]), _vm._v("等")]), _vm._v(" "), _c('li', [_vm._v("大小，一个单词表示宽高同时改变，两个单词前者表示高度、后者表示宽度，类似CSS的"), _c('code', {
    pre: true
  }, [_vm._v("margin")]), _vm._v("或"), _c('code', {
    pre: true
  }, [_vm._v("padding")]), _vm._v("属性。如"), _c('code', {
    pre: true
  }, [_vm._v("size=\"normal\"")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("size=\"large\"")]), _vm._v("、"), _c('code', {
    pre: true
  }, [_vm._v("size=\"mini large\"")]), _vm._v("等")])])]), _vm._v(" "), _c('li', [_vm._v("单词不要缩写，且用连字符而不是驼峰")]), _vm._v(" "), _c('li', [_vm._v("不允许样式块嵌套")]), _vm._v(" "), _c('li', [_vm._v("无需添加浏览器前缀，在PostCSS中已经引入了"), _c('u-link', {
    attrs: {
      "href": "https://github.com/postcss/autoprefixer"
    }
  }, [_vm._v("autoprefixer")]), _vm._v("插件")], 1)]), _vm._v(" "), _c('p', [_vm._v("最佳示例：")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
  ...
  }, [_vm._v("\"$style.root\"")]), _vm._v(">")]), _vm._v("\n    "), _c('span', {
    attrs: {
      "class": "hljs-tag"
    }
  }, [_vm._v("<"), _c('span', {
  ...
  }, [_vm._v("\"$style.track\"")]), _vm._v(">")]), _vm._v("\n        "), _c('span', {
    attrs: {
      "class": "hljs-tag"
    }
  }, [_vm._v("<"), _c('span', {
  ...
  }, [_vm._v("\"$style.trail\"")]), _vm._v(">")]), _c('span', {
    attrs: {
      "class": "hljs-tag"
    }
  }, [_vm._v("</"), _c('span', {
  ...
  }, [_vm._v("background")]), _vm._v(": "), _c('span', {
    attrs: {
      "class": "hljs-number"
    }
  }, [_vm._v("#eee")]), _vm._v(";\n}\n\n"), _c('span', {
  ...
  }, [_vm._v("background")]), _vm._v(": $brand-primary;\n}\n\n"), _c('span', {
    attrs: {
      "class": "hljs-selector-class"
    }
  }, [_vm._v(".root")]), _c('span', {
  ...
  }, [_vm._v("[color=\"success\"]")]), _vm._v(" "), _c('span', {
    attrs: {
      "class": "hljs-selector-class"
    }
  }, [_vm._v(".trail")]), _vm._v(" {\n    "), _c('span', {
  ...
  }, [_vm._v("background")]), _vm._v(": $brand-success;\n}\n\n"), _c('span', {
    attrs: {
      "class": "hljs-selector-class"
    }
  }, [_vm._v(".root")]), _c('span', {
  ...
  }, [_vm._v("style")]), _vm._v(">")]), _vm._v("\n")])]), _vm._v(" "), _c('h4', [_vm._v("优先级问题"), _c('u-link', {
    attrs: {
      "href": "https://github.com/vusion/vusion-cli/issues/21"
    }
  }, [_vm._v("<issue>")])], 1), _vm._v(" "), _c('p', [_vm._v("由于CSS的依赖关系统一走JS，再通过"), _c('u-link', {
    attrs: {
      "href": "https://github.com/webpack-contrib/style-loader"
    }
  }, [_vm._v("style-loader")]), _vm._v("转换为标签插入到页面中，因此无法保证各组件之间的顺序。极少数情况下会有优先级问题，这里我们推荐一种可以提高优先级的写法：")], 1), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-xhtml"
    }
  ...
  }, [_vm._v("\"$style.button\"")]), _vm._v(">")]), _vm._v("Button"), _c('span', {
    attrs: {
      "class": "hljs-tag"
    }
  }, [_vm._v("</"), _c('span', {
  ...
  }, [_vm._v("\"extractCSS\"")]), _vm._v(": "), _c('span', {
    attrs: {
      "class": "hljs-literal"
    }
  ...
  }, [_vm._v("icon-font-loader")]), _vm._v("，它提供一个自定义属性"), _c('code', {
    pre: true
  }, [_vm._v("icon-font")]), _vm._v("，使用时很方便：")], 1), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-css"
    }
  ...
  }, [_vm._v("icon-font")]), _vm._v(": "), _c('span', {
    attrs: {
      "class": "hljs-built_in"
    }
  ...
  }, [_vm._v("'./icons/arrow-down.svg'")]), _vm._v(");\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  ...
  }, [_vm._v("#666")]), _vm._v(";\n}\n")])]), _vm._v(" "), _c('p', [_vm._v("它会转为")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-css"
    }
  ...
  }, [_vm._v("'vusion-icon-font'")]), _vm._v(";\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  ...
  }, [_vm._v("font-weight")]), _vm._v(": "), _c('span', {
    attrs: {
      "class": "hljs-number"
    }
  }, [_vm._v("400")]), _vm._v(";\n    "), _c('span', {
  ...
  }, [_vm._v("font-variant")]), _vm._v(": normal;\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  }, [_vm._v("text-decoration")]), _vm._v(": inherit;\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  }, [_vm._v("text-rendering")]), _vm._v(": optimizeLegibility;\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  }, [_vm._v("text-transform")]), _vm._v(": none;\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  ...
  }, [_vm._v("font-smoothing")]), _vm._v(": antialiased;\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  ...
  }, [_vm._v("#666")]), _vm._v(";\n}\n")])]), _vm._v(" "), _c('p', [_vm._v("同时生成(eot,svg,ttf,woff)等字体和一个全局的@font-face文件。")]), _vm._v(" "), _c('blockquote', [_c('p', [_vm._v("为什么不在HTML或JS中引入图标？类似：")])]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-xhtml"
    }
  ...
  }, [_vm._v("\"require('./inner.svg)\"")]), _vm._v(">")]), _vm._v("\n")])]), _vm._v(" "), _c('ul', [_c('li', [_vm._v("其实大部分图标还需设置CSS属性")]), _vm._v(" "), _c('li', [_vm._v("图片资源的引入本质是一种样式修改")]), _vm._v(" "), _c('li', [_vm._v("CSS具有复写的特性")])]), _vm._v(" "), _c('h4', [_vm._v("svg-sprite")]), _vm._v(" "), _c('p', [_vm._v("svg-sprite拥有css-sprite不具备的调整大小特性。")]), _vm._v(" "), _c('p', [_vm._v("在Vusion中，我们使用了一个"), _c('u-link', {
    attrs: {
      "href": "https://github.com/CXHtml/svg-sprite-loader"
    }
  }, [_vm._v("svg-sprite-loader")]), _vm._v("。使用起来也很方便：")], 1), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-css"
    }
  ...
  }, [_vm._v("svg-sprite")]), _vm._v(": "), _c('span', {
    attrs: {
      "class": "hljs-built_in"
    }
  }, [_vm._v("url")]), _vm._v("("), _c('span', {
  ...
  }, [_vm._v("'./icons/refresh.svg'")]), _vm._v(");\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  }, [_vm._v("width")]), _vm._v(": "), _c('span', {
  ...
  }, [_vm._v("'/public/sprite.1c9f4bcca4a42798.svg#refresh'")]), _vm._v(");\n    "), _c('span', {
    attrs: {
      "class": "hljs-attribute"
    }
  }, [_vm._v("width")]), _vm._v(": "), _c('span', {
  ...
  }, [_vm._v("120px")]), _vm._v(";\n}\n")])]), _vm._v(" "), _c('h4', [_vm._v("css-sprite")]), _vm._v(" "), _c('p', [_vm._v("正在研究中。。。")]), _vm._v(" "), _c('p', [_vm._v("可以先使用CSS的background，会走"), _c('u-link', {
    attrs: {
      "href": "https://github.com/webpack-contrib/file-loader"
    }
  }, [_vm._v("file-loader")]), _vm._v("。")], 1), _vm._v(" "), _c('h4', [_vm._v("其他资源")]), _vm._v(" "), _c('p', [_vm._v("其他资源会统一走"), _c('u-link', {
    attrs: {
      "href": "https://github.com/webpack-contrib/file-loader"
    }
  }, [_vm._v("file-loader")]), _vm._v("，目前已配置了"), _c('code', {
    pre: true
  }, [_vm._v("png|jpg|gif|eot|ttf|woff|woff2")]), _vm._v("这些格式"), _c('u-link', {
    attrs: {
      "href": "https://github.com/vusion/vusion-cli/blob/develop/webpack/base.js#L88"
    }
  }, [_vm._v("<code>")]), _vm._v("。")], 1)])
}
var staticRenderFns = []
